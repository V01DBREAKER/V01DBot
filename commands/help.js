	...
	if (args.length < 1) {
		message.author.send({embed: {
			...
			fields: [{
				...
				value: "If you have Manage Server permissions for your guild, you can invite it here: [Invite](https://discordapp.com/api/oauth2/authorize?client_id=329191944167358474&scope=bot&permissions=506981446)"
			},
			{
